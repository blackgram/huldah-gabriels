  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow lg:max-w-[90%] xl:max-w-[100%]">
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h2 className="text-2xl font-bold mb-3">Order Management Coming Soon</h2>
        
        <p className="text-gray-600 max-w-lg mb-6">
          Hi lol, I'm still working on building a powerful order management system to help you track and fulfill customer orders efficiently. As the good friend I am.
        </p>
