...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <div className="fixed w-full top-0 left-0 px-4 xl:px-14 flex items-center justify-between text-white font-urbanist bg-white z-50 transition-all ease-in-out duration-500">
      ...
      <div className="flex justify-evenly xl:gap-5 bg-primary rounded-b-2xl text-[10px] sm:text-[12px] xl:text-[20px] px-4 border-b-primary border-b border-t border-t-primary">
        <div
      ...
      <div onClick={() => dispatch(setShowCart(!showCart))} className="relative border-b border-r border-l border-primary rounded-b-lg cursor-pointer lg:flex lg:text-black lg:items-center lg:justify-center lg:px-5">
        {showCart ? <IoClose className="text-[35px] text-primary" /> : (
